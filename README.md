...
```html
<script src="https://unpkg.com/@loggy/adapter-browser@0.1.1/dist/loggy-client-browser.js" crossorigin></script>
```
...
```html
<script src="https://unpkg.com/@loggy/adapter-browser@0.1.2/dist/loggy-client-browser.js" crossorigin></script>
